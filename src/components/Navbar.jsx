...
function Navbar() {
  ...
  return (
    <>
    <div>
    <div class="max-w-screen-2xl container mx-auto md:px-20 px-4 fixed top-0 left-0 right-0 md:flex md:flex-col">
  ...
  <label className="px-3 py-2 border flex items-center gap-2 rounded-md">
  ...
  <div className="">
    <a className="bg-black p-2 text-white rounded-md hover:bg-slate-800 duration-300">Login</a>
  </div>
</div>
</div>
    </div>
